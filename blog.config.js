...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '广知阁', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '本站是由多个作者共同创作的博客网站', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://prosophia.com', // 网站地址
